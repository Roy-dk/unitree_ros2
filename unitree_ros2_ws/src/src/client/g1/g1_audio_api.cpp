...
void AudioClientApi::TtsMakerReq(
...
int32_t AudioClientApi::TtsMakerRes(
    const std::shared_ptr<unitree_api::srv::Generic::Response> &res) {
  return res->code;
}

void AudioClientApi::GetVolumeReq(
    const std::shared_ptr<unitree_api::srv::Generic::Request> &req) {
  req->api_id = ROBOT_API_ID_AUDIO_GET_VOLUME;
}

int32_t AudioClientApi::GetVolumeRes(
    const std::shared_ptr<unitree_api::srv::Generic::Response> &res,
    uint8_t &volume) {
  if (res->code == 0) {
...
void AudioClientApi::SetVolumeReq(
    uint8_t volume,
    const std::shared_ptr<unitree_api::srv::Generic::Request> &req) {
  nlohmann::json js;
  js["volume"] = volume;
...
int32_t AudioClientApi::SetVolumeRes(
    const std::shared_ptr<unitree_api::srv::Generic::Response> &res) {
  return res->code;
}

void AudioClientApi::PlayStreamReq(
...
int32_t AudioClientApi::PlayStreamRes(
    const std::shared_ptr<unitree_api::srv::Generic::Response> &res) {
  return res->code;
}

void AudioClientApi::PlayStopReq(
...
int32_t AudioClientApi::PlayStopRes(
    const std::shared_ptr<unitree_api::srv::Generic::Response> &res) {
  return res->code;
}
...
int32_t AudioClientApi::LedControlRes(
    const std::shared_ptr<unitree_api::srv::Generic::Response> &res) {
  return res->code;
}
