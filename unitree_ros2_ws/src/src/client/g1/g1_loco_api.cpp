...
void LocoClientApi::GetFsmModeReq(
    const std::shared_ptr<unitree_api::srv::Generic::Request> &req) {
  req->api_id = ROBOT_API_ID_LOCO_GET_FSM_MODE;
}

int32_t LocoClientApi::GetFsmModeRes(
    const std::shared_ptr<unitree_api::srv::Generic::Response> &res,
    int32_t &fsm_mode) {
  if (res->code == 0) {
    auto js = nlohmann::json::parse(res->data.c_str());
...
void LocoClientApi::GetBalanceModeReq(
    const std::shared_ptr<unitree_api::srv::Generic::Request> &req) {
  req->api_id = ROBOT_API_ID_LOCO_GET_BALANCE_MODE;
}

int32_t LocoClientApi::GetBalanceModeRes(
    const std::shared_ptr<unitree_api::srv::Generic::Response> &res,
...
void LocoClientApi::GetSwingHeightReq(
    const std::shared_ptr<unitree_api::srv::Generic::Request> &req) {
  req->api_id = ROBOT_API_ID_LOCO_GET_SWING_HEIGHT;
}

int32_t LocoClientApi::GetSwingHeightRes(
    const std::shared_ptr<unitree_api::srv::Generic::Response> &res,
    float &swing_height) {
  if (res->code == 0) {
    auto js = nlohmann::json::parse(res->data.c_str());
...
void LocoClientApi::GetStandHeightReq(
    const std::shared_ptr<unitree_api::srv::Generic::Request> &req) {
  req->api_id = ROBOT_API_ID_LOCO_GET_STAND_HEIGHT;
}

int32_t LocoClientApi::GetStandHeightRes(
    const std::shared_ptr<unitree_api::srv::Generic::Response> &res,
    float &stand_height) {
  if (res->code == 0) {
    auto js = nlohmann::json::parse(res->data.c_str());
...
void LocoClientApi::GetPhaseReq(
    const std::shared_ptr<unitree_api::srv::Generic::Request> &req) {
  req->api_id = ROBOT_API_ID_LOCO_GET_PHASE;
}

int32_t LocoClientApi::GetPhaseRes(
    const std::shared_ptr<unitree_api::srv::Generic::Response> &res,
...
int32_t LocoClientApi::SetFsmIdRes(
    const std::shared_ptr<unitree_api::srv::Generic::Response> &res) {
  return res->code;
}
...
int32_t LocoClientApi::SetBalanceModeRes(
    const std::shared_ptr<unitree_api::srv::Generic::Response> &res) {
  return res->code;
}
...
int32_t LocoClientApi::SetSwingHeightRes(
    const std::shared_ptr<unitree_api::srv::Generic::Response> &res) {
  return res->code;
}
...
int32_t LocoClientApi::SetStandHeightRes(
    const std::shared_ptr<unitree_api::srv::Generic::Response> &res) {
  return res->code;
}

void LocoClientApi::SetVelocityReq(
...
int32_t LocoClientApi::SetVelocityRes(
    const std::shared_ptr<unitree_api::srv::Generic::Response> &res) {
  return res->code;
}
...
int32_t LocoClientApi::SetTaskIdRes(
    const std::shared_ptr<unitree_api::srv::Generic::Response> &res) {
  return res->code;
}
